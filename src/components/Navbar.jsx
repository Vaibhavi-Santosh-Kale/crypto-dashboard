...
const dispatch =useDispatch();
  return (
    <div className={`flex ${isDark?"bg-gray-800 text-white border-gray-600":"bg-white text-black"}  select-none h-[60px] w-full shadow-xl justify-between items-center border-b-2  pr-4`}>
      ...
      <div className='h-fit w-fit' onClick={()=>{dispatch(changetheme())}}>
        {isDark === true ? <MdLightMode size={30} color="" /> : <MdNightlight size={30}/>
        }
      </div>
    </div>
  )
