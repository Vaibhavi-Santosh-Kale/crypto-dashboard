                  ...
                  <div className="flex-col w-full">
                    <div className="flex w-full justify-between">
                      <span className="flex font-bold text-1xl text-gray-700 w-fit">
                        <img
                          className="sm:h-8 sm:w-8 h-10 w-10 m-1 rounded-full"
                          src={image}
                          alt="Currency Logo"
                        />
                        ...
                        <div className="flex flex-row justify-end">
                          <span className="flex m-1  ">
                            {price_change_percentage_24h < 0 ? (
                              <VscTriangleDown color="red" size={20} />
                            ) : (
                              <VscTriangleUp color="green" size={20} />
                            )}
                          </span>
                          <span className="h-fit w-10 text-gray-500">
                    ...
                    <div
                      className={`hidden group-hover:flex p-2 pb-0 text-[13px] text-gray-500 justify-between font-semibold`}
                    >
                      <div className="flex flex-col">
